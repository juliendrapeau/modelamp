...
def compute_amplitude_z_array(circuit: QuantumCircuit, z_array: np.ndarray):
    """
    Computes ⟨z | ψ⟩ where z is given as a NumPy array of bits.
    ...
    #z_str2 = ''.join(str(b) for b in z_array)
    #print(psi[int(z_str2, 2)])
...
if __name__ == "__main__":
    ...
    final_state = np.ones(num_qubits, dtype=int)   # |1>
    ...
    #print(stdout)
    model_count = parse_ganak_complex_output(stdout)
